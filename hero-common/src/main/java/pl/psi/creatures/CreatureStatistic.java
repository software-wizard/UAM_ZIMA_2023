...
{
    // NECROPILIS FRACTION
    SKELETON( "Skeleton", 5, 4, 6, 4, Range.closed( 1, 3 ), List.of(CreatureSpecialAttributeTypes.EVIL),1,
        "Average lvl1 foot soldier, but always in huge numbers thanks to necromancy skill and skeleton transformer.",
        false ), //
    WALKING_DEAD( "Walking Dead", 5, 5, 15, 3, Range.closed( 2, 3 ), List.of(CreatureSpecialAttributeTypes.EVIL), 2,
        "Basically its the same skeleton with more hit points. I prefer buying 2 skeletons instead.", false ), //
    WIGHT( "Wight", 7, 7, 18, 5, Range.closed( 3, 5 ), List.of(CreatureSpecialAttributeTypes.EVIL),3,
        ...
        false ), //
    VAMPIRE( "Vampire", 10, 9, 30, 6, Range.closed( 5, 8 ), List.of(CreatureSpecialAttributeTypes.EVIL),4,
        ...
        false ), //
    LICH( "Lich", 13, 10, 30, 6, Range.closed( 11, 15 ), List.of(CreatureSpecialAttributeTypes.EVIL),5,
        ...
        false ), //
    BLACK_KNIGHT( "Black Knight", 16, 16, 120, 7, Range.closed( 15, 30 ), List.of(CreatureSpecialAttributeTypes.EVIL), 6,
        ...
        false ), //
    BONE_DRAGON( "Bone Dragon", 17, 15, 150, 9, Range.closed( 25, 50 ), List.of(CreatureSpecialAttributeTypes.EVIL), 7,
        ...
        false ), //
    SKELETON_WARRIOR( "Skeleton Warrior", 6, 6, 6, 5, Range.closed( 1, 3 ), List.of(CreatureSpecialAttributeTypes.EVIL), 1,
        ...
        true ), //
    ZOMBIE( "Zombie", 5, 5, 20, 4, Range.closed( 2, 3 ), List.of(CreatureSpecialAttributeTypes.EVIL),2,
        ...
        true ), //
    WRAITH( "Wraith", 7, 7, 18, 5, Range.closed( 3, 5 ), List.of(CreatureSpecialAttributeTypes.EVIL), 3,
        "Regenerating ability is really good when fighting weak enemies, especially shooters.\nSpecial: top wight of the stack regenerates all lost damage in the beginning of each round\n",
        true ), //
    VAMPIRE_LORD( "Vampire Lord", 10, 10, 40, 9, Range.closed( 5, 8 ), List.of(CreatureSpecialAttributeTypes.EVIL),4,
        ...
        true ), //
    POWER_LICH( "Power Lich", 13, 10, 40, 7, Range.closed( 11, 15 ), List.of(CreatureSpecialAttributeTypes.EVIL), 5,
        "Now they last longer and are able to do more damage! A must for good necropolis army.\nSpecial: death cloud range attack - damages living creatures on adjacent hexes to target.\n",
        true ), //
    DREAD_KNIGHT( "Dread Knight", 18, 18, 120, 9, Range.closed( 15, 30 ), List.of(CreatureSpecialAttributeTypes.EVIL), 6,
        ...
        true ), //
    GHOST_DRAGON( "Ghost Dragon", 19, 17, 200, 14, Range.closed( 25, 50 ), List.of(CreatureSpecialAttributeTypes.EVIL), 7,
    ...
    CreatureStatistic(final String aName, final int aAttack, final int aArmor, final int aMaxHp,
                      final int aMoveRange, final Range< Integer > aDamage, final List<CreatureSpecialAttributeTypes> aSpecialAttributes,
                      final int aTier, final String aDescription, final boolean aIsUpgraded )
    {
        name = aName;
        attack = aAttack;
        armor = aArmor;
        ...
        damage = aDamage;
        specialAttributes = aSpecialAttributes;
        tier = aTier;
